  ...
  return (
    <div className="space-y-6 animate-fade-in">
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="inline-flex items-center gap-1 px-3 py-1 bg-green-100  
      ...
      <div className="bg-white  rounded-xl border border-slate-200  p-6 shadow-card">
        ...
        <div className="bg-brand-50  border border-blue-200  rounded-lg p-4 mb-4">
        ...
        <div className="space-y-3">
          {/* 신고 대상 */}
          <div className="flex items-start gap-3 p-3 rounded-lg bg-green-50  border border-green-100 dark:border-green-900/30">
          ...
          {/* 신고 제외 1 */}
          <div className="flex items-start gap-3 p-3 rounded-lg bg-slate-50  border border-slate-200 dark:border-slate-700">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-slate-50 dark:bg-slate-900/50">
                ...
                <th className="text-center px-4 py-2.5 font-semibold text-slate-600  w-24">품목코드</th>
              ...
              {CONTAINER_TYPE_MAP.map((item, idx) => (
                <tr key={idx} className="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                  ...
                  <td className="px-4 py-2.5 text-center">
                    <span className="inline-block px-2 py-0.5 bg-brand-100  
                                     text-brand-700  rounded text-xs font-mono font-bold">
                      {item.code}
                    </span>
                  </td>
