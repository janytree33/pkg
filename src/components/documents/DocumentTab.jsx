    ...
    <div className="flex flex-col h-full bg-gray-50">
      ...
      <div className="bg-white p-6 border-b border-gray-200">
        <h2 className="text-xl font-bold mb-4 text-gray-800 flex items-center">
          <FileDown className="mr-2 h-6 w-6 text-blue-600" />
          용기 사양서 발행
        </h2>
        ...
        <div className="flex space-x-3">
          ...
          <button
            ...
            className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded flex items-center justify-center transition-colors shadow-sm"
          >
                ...
                <tr key={doc.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-sm">
                    ...
                    <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${
                      doc.type === 'PDF' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800'
                    }`}>
                      {doc.type}
                    </span>
                  </td>
