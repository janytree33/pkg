  ...
  return (
    <div className="p-6 space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* 완제품 요약 */}
        <div className="bg-white dark:bg-slate-800 rounded-xl p-5 border border-slate-200 dark:border-slate-700 shadow-card">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-sm font-medium text-slate-500 dark:text-slate-400">등록된 완제품</p>
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mt-1">{totalProducts}건</h3>
            </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl p-5 border border-slate-200 dark:border-slate-700 shadow-card">
          <div className="flex items-start justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mt-1">{totalPackaging}건</h3>
            </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl p-5 border border-slate-200 dark:border-slate-700 shadow-card">
          <div className="flex items-start justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mt-1">{totalDocs}건</h3>
            </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl p-5 border border-slate-200 dark:border-slate-700 shadow-card">
          <div className="flex items-start justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mt-1">{totalReports}건</h3>
            </div>
      ...
      {/* 퀵 액션 */}
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-card p-6">
        <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">빠른 작업 시작</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button
            onClick={() => navigate('/items')}
            className="flex items-center justify-between p-4 rounded-lg border border-slate-200 dark:border-slate-700 hover:border-brand-500 hover:bg-brand-50 dark:hover:bg-brand-900/20 transition-all text-left group"
          >
            <div className="flex items-center gap-3">
              <div className="p-2 bg-brand-100 dark:bg-brand-900/50 rounded-lg text-brand-600 dark:text-brand-400 group-hover:scale-110 transition-transform">
                <Package size={20} />
              </div>
              <div>
                <p className="font-semibold text-slate-800 dark:text-slate-200">품목 및 포장재 등록</p>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">신규 제품이나 BOM을 구성합니다</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">PDF 사양서를 자동 생성합니다</p>
              </div>
            </div>
            <ArrowRight size={16} className="text-slate-400 group-hover:text-brand-500 group-hover:translate-x-1 transition-transform" />
          </button>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">신고용 중량산출 엑셀을 만듭니다</p>
              </div>
            </div>
            <ArrowRight size={16} className="text-slate-400 group-hover:text-brand-500 group-hover:translate-x-1 transition-transform" />
          </button>
